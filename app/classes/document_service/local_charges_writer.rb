module DocumentService
  class LocalChargesWriter
    ...
    def local_charges_header_test
      %w[EFFECTIVE_DATE EXPIRATION_DATE DESTINATION SERVICE_LEVEL FEE MOT FEE_CODE  LOAD_TYPE DIRECTION CURRENCY  RATE_BASIS  TON CBM KG  ITEM  SHIPMENT  BILL  CONTAINER MINIMUM WM]
    end
