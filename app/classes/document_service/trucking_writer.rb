...
module DocumentService
  class TruckingWriter
    ...
    def update_pages(meta, ufr)
      ...
      pages[page_key][:pricings].push(ufr) unless pages[page_key][:pricings].include?(ufr)
    end

    def update_dir_fees(meta, ufr)
      dir_fees[meta[:direction]] = ufr['truckingPricing']['fees'] unless dir_fees[meta[:direction]]
    end
