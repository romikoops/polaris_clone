class LclCargo < ActiveRecord::Base
  belongs_to :shipment
  ...
  def self.extract_cargos(params)
    ...
    params.each_key do |key|
      ...
      unless value["_destroy"] == "1"
        cargos << LclCargo.new(payload_in_kg: payload_in_kg, dimension_x: dimension_x, dimension_y: dimension_y, dimension_z: dimension_z)
      end
    end
    cargos
  end
