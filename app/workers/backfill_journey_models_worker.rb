      ...
      <<~SQL
        INSERT INTO journey_queries (
          ...
          SELECT
            ...
            COALESCE(pickup_addresses.geocoded_address, origin_nexuses.name),
            ST_SetSRID(ST_MakePoint(COALESCE(pickup_addresses.longitude, origin_nexuses.longitude), COALESCE(pickup_addresses.latitude, origin_nexuses.latitude)), 4326),
            COALESCE(delivery_addresses.geocoded_address, destination_nexuses.name),
            ST_SetSRID(ST_MakePoint(COALESCE(delivery_addresses.longitude, destination_nexuses.longitude), COALESCE(delivery_addresses.latitude, destination_nexuses.latitude)), 4326),
