...
module Queries
  module Route
    class FullAttributesFromItineraryIds
      ...
      def raw_query
        @options[:with_truck_types] ? raw_query_with_truck_types_switch : raw_query_without_truck_types_switch
      end

      def raw_query_with_truck_types_switch
        @options[:base_pricing] ? raw_query_with_truck_types_base_pricing : raw_query_with_truck_types
      end

      def raw_query_without_truck_types_switch
        @options[:base_pricing] ? raw_query_without_truck_types_base_pricing : raw_query_without_truck_types
      end
      ...
      def raw_query_without_truck_types_base_pricing
        <<-SQL
          SELECT
