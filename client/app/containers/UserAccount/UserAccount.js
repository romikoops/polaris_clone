                    ...
                    <div className="layout-row flex-100 ">
                        ...
                        <Switch className="flex">
                            ...
                            <Route
                                ...
                                render={props => <UserProfile setNav={this.setNavLink} theme={theme} user={user} aliases={dashboard.aliases} {...props} locations={dashboard.locations} userDispatch={userDispatch} authDispatch={authDispatch}/>}
                            />
                            <Route
