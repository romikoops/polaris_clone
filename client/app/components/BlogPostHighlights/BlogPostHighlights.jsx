...
export function BlogPostHighlights ({ theme }) {
  ...
  dummyPosts.forEach((dp, i) => {
    ...
    const dbp = (
      ...
      <div key={i} className={`${styles.blog_post} layout-column`}>
        <div className={`${styles.bp_image} flex-33`} style={divStyle} />
        <div className="flex-66 layout-column layout-align-center-start">
          <div className={`flex-66 layout-column layout-align-start-center ${styles.bp_text}`}>
            ...
            <div
              className="flex-66 layout-row layout-align-center-center"
              style={{ width: '100%' }}
            >
