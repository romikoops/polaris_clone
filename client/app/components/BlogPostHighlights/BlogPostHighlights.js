...
export class BlogPostHighlights extends Component {
    render() {
        const dummyPost = {
            ...
            text:
                'Lorem ipsum dolor sit amet, consectetur adipiscing elit. In vel leo dapibus, aliquam metus nec, pulvinar.',
            image:
                'https://assets.itsmycargo.com/assets/images/welcome/country/shipping-containers.jpg'
        };
        const dummyPosts = [];
        ...
        for (let i = 2; i >= 0; i--) {
            ...
            const dbp = (
                <div key={i} className="blog_post layout-column">
