    ...
    render() {
        const activeRoutesData = [
            {
                ...
                country: 'USA',
                image:
                    'https://assets.itsmycargo.com/assets/images/welcome/country/NY.jpg'
            },
            {
                name: 'Shanghai',
                country: 'China',
                image:
                    'https://assets.itsmycargo.com/assets/images/welcome/country/shanghai.jpg'
            },
            {
                name: 'Singapore',
                country: 'Singapore',
                image:
                    'https://assets.itsmycargo.com/assets/images/welcome/country/Singapore.jpg'
            },
            {
                name: 'Seoul',
                country: 'South Korea',
                image:
                    'https://assets.itsmycargo.com/assets/images/welcome/country/seoul.jpg'
            },
            {
                name: 'Hanoi',
                country: 'Vietnam',
                image:
                    'https://assets.itsmycargo.com/assets/images/welcome/country/Hanoi.jpg'
            },
            {
                name: 'Shenzhen',
                country: 'China',
                image:
                    'https://assets.itsmycargo.com/assets/images/welcome/country/Shenzhen.jpg'
            }
        ];
        ...
        activeRoutesData.map((route, index) => {
            ...
            const arb = (
                <div
                    key={index}
                    className="active_route flex-33 layout-row layout-align-center-center"
                    style={divStyle}
                >
