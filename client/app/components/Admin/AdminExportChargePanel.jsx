...
export class AdminExportChargePanel extends Component {
  constructor (props) {
    super(props)
        ...
        >
          ...
          >
            <div className="flex-100 layout-row layout-align-start-start">
              <h3 className="flex-none offset-5">{t('admin:export')}</h3>
            </div>
...
AdminExportChargePanel.propTypes = {
...
AdminExportChargePanel.defaultProps = {
  theme: null,
  hub: null,
  charge: null
}

export default withNamespaces('admin')(AdminExportChargePanel)
