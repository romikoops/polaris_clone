...
export class AdminPricePanel extends Component {
  ...
  render () {
    ...
    Object.keys(pricing).forEach((key) => {
      if (key !== 'created_at' && key !== 'updated_at' && key !== 'tenant_id' && key !== 'customer_id' && key !== 'route_id' && key !== 'dedicated') {
        ...
        Object.keys(pricing[key]).forEach((ky2) => {
          if (ky2 !== 'currency') {
            sections[key].push(<div key={v4()} className="flex-100 layout-row">
    ...
    const PriceSection = ({ pkey }) => (<div key={v4()} className={`flex-none layout-row layout-wrap ${styles.price_card}`}>
