...
export default function ContactDetailsRow ({
  ...
  return (
    <div className={`layout-row flex-100 layout-wrap margin_bottom ${adminStyles.margin_box_right}`}>
      {isAccountHolder === '' ? <div className={`flex-100 ${flexSize} layout-row layout-align-center-center card_padding_right`}>
        <AlternativeGreyBox
      ...
      <div className={`flex-100 ${flexSize} layout-row layout-align-center-center card_padding_right`}>
        <AlternativeGreyBox
          title="Shipper"
