    ...
    render() {
        ...
        return(
            <div className={`flex-none ${styles.client_card} layout-row`} onClick={this.clickEv}>
                ...
                <div className={`${styles.content} layout-row layout-align-center-start`}>
                    <div className="flex-95 layout-row layout-wrap layout-align-start-start">
                        <div className="flex-100 layout-row layout-align-space-around-center">
                          ...
                          <h4 className="flex-100"> {client.first_name} {client.last_name} </h4>
                        </div>
                        <div className="flex-100 layout-row layout-align-space-around-center">
                          <i className="flex-none fa fa-envelope" style={gradientStyle}/>
                          <p className="flex-100">{ client.email }</p>
                        </div>
                        <div className="flex-100 layout-row layout-align-space-around-center">
                          <i className="flex-none fa fa-building" style={gradientStyle}/>
                          <p className="flex-100">{ client.company_name }</p>
                        </div>
                    </div>
                </div>
            </div>
