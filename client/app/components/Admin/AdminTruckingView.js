...
export class AdminTruckingView extends Component {
    ...
    render() {
        ...
        const CityCell = ({rates}) => {
            return (<div key={v4()} className={`flex-100 layout-row layout-align-start-center layout-wrap ${styles.trucking_zip_row}`}>
                <div className="flex-100 layout-row layout-align-start-center">
                    <div className={`flex-25 layout-row layout-align-start-center layout-wrap ${styles.trucking_cell}`}>
        ...
        const ZipRow = ({rates}) => {
            return (<div key={v4()} className={`flex-100 layout-row layout-align-start-center layout-wrap ${styles.trucking_zip_row}`}>
                <div className="flex-100 layout-row layout-align-start-center">
                    <div className={`flex layout-row layout-align-start-center layout-wrap ${styles.trucking_cell}`}>
                        <p className={`flex-100 ${styles.trucking_cell_label}`}>Min Weight</p>
                        <p className="flex-100">{rates.min}</p>
                    </div>
                    <div className={`flex layout-row layout-align-start-center layout-wrap ${styles.trucking_cell}`}>
        ...
        const CityView = ({pricingInstance, viewExpander, expandFn, panelStyle}) => {
            return (<div key={v4()} className="flex-100 layout-row layout-align-start-start layout-wrap">
                <div className={`flex-100 layout-row layout-align-start-center ${styles.trucking_header_card}`}>
                    <div className={`flex layout-row layout-align-start-center layout-wrap ${styles.trucking_city_header}`}>
                    ...
                    <div className={`flex-10 layout-row layout-align-center-center ${styles.trucking_city_header}`} onClick={() => expandFn(pricingInstance.city)}>
                        { viewExpander[pricingInstance.city] ? <i className="fa fa-chevron-up clip" style={textStyle} /> : <i className="fa fa-chevron-down clip" style={textStyle} />}
                    </div>
                </div>
                <div className={`flex-100 layout-row layout-align-start-center layout-wrap ${panelStyle} ${styles.trucking_panel}`}>
            ...
            return (<div key={v4()} className={`flex-100 layout-row layout-align-start-start layout-wrap ${styles.trucking_zip}`}>
                <div className={`flex-100 layout-row layout-align-start-center ${styles.trucking_header_card}`}>
                    <div className={`flex layout-row layout-align-start-center ${styles.trucking_city_header}`}>
                        ...
                        <p className="flex-50">{pricingInstance.lower_zip} - {pricingInstance.upper_zip}</p>
                    </div>
                    {/* <div className={`flex layout-row layout-align-start-center layout-wrap ${styles.trucking_city_header}`}>
                                    <p className={`flex-100 ${styles.trucking_city_header_label}`}>Upper ZipCode</p>
                                    <p className="flex-100">{pricingInstance.upper_zip}</p>
                                </div> */}
                    <div className={`flex layout-row layout-align-start-center ${styles.trucking_city_header}`}>
                        <p className={`flex-50 ${styles.trucking_city_header_label}`}>Currency</p>
                        <p className="flex-50">{pricingInstance.currency}</p>
                    </div>
                    <div className={`flex-10 layout-row layout-align-center-center ${styles.trucking_city_header}`} onClick={() => expandFn(pricingInstance.lower_zip)}>
                        { viewExpander[pricingInstance.lower_zip] ? <i className="fa fa-chevron-up clip" style={textStyle} /> : <i className="fa fa-chevron-down clip" style={textStyle} />}
                    </div>
                </div>
                <div className={`flex-100 layout-row layout-align-start-center layout-wrap ${panelStyle} ${styles.trucking_panel}`}>
        ...
        return(
            <div className="flex-100 layout-row layout-wrap layout-align-start-start">
                <div className={`flex-100 layout-row layout-align-space-between-center ${styles.sec_title}`}>
                    <p className={` ${styles.sec_title_text} flex-none`} style={textStyle}>{nexus.name}</p>
                    {backButton}
                </div>
