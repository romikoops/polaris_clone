...
export class AdminShipmentsComp extends Component {
  ...
  handlePage (target, delta) {
    ...
    //   const nextPage = prevState.pages[target] + (1 * delta)
  ...
  render () {
    ...
    const mergedOpenShipments = filters.sortByDate(shipments.open, 'booking_placed_at')
      .map(sh => AdminShipmentsComp.prepShipment(sh, clientHash, hubHash))
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminShipmentsComp)
