...
function UserShipmentCard (props) {
  const handleView = () => {
    const { shipment, dispatches } = props
  ...
  return (
    ...
    >
      ...
      <div className={adminStyles.card_link} onClick={() => handleView()} />
      ...
      >
        ...
        <div className={`layout-row flex-20 layout-align-start-center ${styles.ett}`}>
          {!!shipment.planned_etd && !!shipment.planned_eta && (
            <div>
              <b>
      ...
      >
        ...
        <div className="layout-row flex layout-align-end-end">
          {(shipment.total_price || shipment.edited_total) && (
