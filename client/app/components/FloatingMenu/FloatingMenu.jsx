...
export class FloatingMenu extends Component {
  ...
  render () {
    ...
    const AnimIcon = styled.div`
      :hover {
        animation: ${rotateIcon} 1.5s linear;
      }
      ${Title}:hover & {
        animation: ${rotateIcon} 1.5s linear;
      }
    ...
    return (
      ...
      >
        ...
        >
          <AnimIcon
            className={`flex-none layout-row layout-align-center-center ${styles.icon_circle}`}
          >
        ...
        <div className={`flex-100 layout-row ${styles.menu_content} ${currentStyle}`}>{Comp}</div>
      </div>
    )
  }
}
