  ...
  render () {
    ...
    return (
      <div>
        ...
        <div className={`${styles.floating_menu} ${this.state.expand ? '' : styles.collapsed}`}>
          <div
            className={`${styles.inner_wrapper} flex-none layout-column layout-align-space-between`}
            ...
            <div>
              ...
              >
                <div className="flex-none layout-row layout-align-start-center">
                  ...
                  <p style={this.state.collapsePromptOverwriteP}>{t('common:collapseSidebar')}</p>
                </div>
              </div>
            </div>
          </div>
...
export default withNamespaces('common')(FloatingMenu)