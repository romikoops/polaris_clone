export const gradientGenerator = (colour1, colour2, direction = '-90deg') => {
  if ((navigator.userAgent.indexOf('Opera') || navigator.userAgent.indexOf('OPR')) !== -1) {
    ...
    return { background: `linear-gradient(to left, ${colour1} 0%, ${colour2} 100%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=${colour1}, endColorstr=${colour2})` }
  }
...
export const gradientCSSGenerator = (colour1, colour2, direction = '-90deg') => {
  if ((navigator.userAgent.indexOf('Opera') || navigator.userAgent.indexOf('OPR')) !== -1) {
    ...
    return `linear-gradient(to left, ${colour1} 0%, ${colour2} 100%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=${colour1}, endColorstr=${colour2})`
  }
...
export const gradientBorderGenerator = (colour1, colour2, direction = '-90deg') => {
  if ((navigator.userAgent.indexOf('Opera') || navigator.userAgent.indexOf('OPR')) !== -1) {
    ...
    return { backgroundImage: `linear-gradient(to left, ${colour1} 0%, ${colour2} 100%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=${colour1}, endColorstr=${colour2})` }
  }
