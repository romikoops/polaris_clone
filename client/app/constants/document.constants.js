export const documentConstants = {
  ...
  DOWNLOAD_PRICINGS_REQUEST: 'DOWNLOAD_PRICINGS_REQUEST',
  DOWNLOAD_PRICINGS_SUCCESS: 'DOWNLOAD_PRICINGS_SUCCESS',
  DOWNLOAD_PRICINGS_FAILURE: 'DOWNLOAD_PRICINGS_FAILURE'
}
