...
Feature: Booking Process
  ...
  Scenario Outline: Creating a booking
    ...
    Examples:
      ...
      | Selling (Export) | Ocean FCL & Rail FCL      | William Gibsons väg 13, 433 76 Jonsered, Sweden | Shanghai                       | 1 "20‘ Dry Container" with weight of 25000kg                          | yes       | no        |
      | Selling (Export) | Ocean FCL & Rail FCL      | Gothenburg                                      | Henan Middle Road 88, Shanghai | 1 "20‘ Dry Container" with weight of 25000kg                          | yes       | no        |
      | Selling (Export) | Ocean FCL & Rail FCL      | William Gibsons väg 13, 433 76 Jonsered, Sweden | Henan Middle Road 88, Shanghai | 1 "20‘ Dry Container" with weight of 25000kg                          | yes       | no        |
      | Selling (Export) | Ocean FCL & Rail FCL      | Gothenburg                                      | Shanghai                       | 1 "20‘ Dry Container" with weight of 25000kg                          | yes       | no        |
      | Selling (Export) | Ocean FCL & Rail FCL      | Gothenburg                                      | Shanghai                       | 1 "40‘ Dry Container" with weight of 15000kg                          | yes       | no        |
      ...
      | Buying (Import)  | Ocean FCL & Rail FCL      | Shanghai                                        | Gothenburg                     | 1 "20‘ Dry Container" with weight of 25000kg                          | no        | yes       |
      | Buying (Import)  | Ocean FCL & Rail FCL      | Shanghai                                        | Gothenburg                     | 1 "40‘ Dry Container" with weight of 15000kg                          | yes       | yes       |
