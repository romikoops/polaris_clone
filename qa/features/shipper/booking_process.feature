...
Feature: Booking Process
  ...
  Scenario Outline: Creating a booking
    ...
    Examples:
      ...
      | Selling (Export) | Ocean FCL & Rail FCL      | Gothenburg                                      | Henan Middle Road 88, Shanghai     | 1 "20‘ Dry Container" with weight of 2500kg                            | yes       | no        |
      | Selling (Export) | Ocean FCL & Rail FCL      | William Gibsons väg 13, 433 76 Jonsered, Sweden | Henan Middle Road 88, Shanghai     | 1 "20‘ Dry Container" with weight of 2500kg                            | yes       | no        |
