...
Rails.application.config.sorcery.submodules = %i(user_activation reset_password brute_force_protection activity_logging)
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = Mailers::UserMailer
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = Mailers::UserMailer
    ...
    # Default: `nil`
    #
    user.unlock_token_mailer = Mailers::UserMailer
  ...
  config.user_class = 'Tenants::User'
end
