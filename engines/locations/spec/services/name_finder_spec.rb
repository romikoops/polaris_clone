...
RSpec.describe Locations::NameFinder do
  context 'searching for location names' do
    ...
    let!(:location_names) do
      [
        FactoryBot.create(:locations_name, city: 'Shanghai', name: 'Baoshun'),
        FactoryBot.create(:locations_name, city: 'Taicung', name: 'Baoshun' ),
        FactoryBot.create(:locations_name, city: 'Qingdao', name: 'Baoshun' )
      ]
    end
