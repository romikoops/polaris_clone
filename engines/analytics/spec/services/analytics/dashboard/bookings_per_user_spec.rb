...
RSpec.describe Analytics::Dashboard::BookingsPerUser, type: :service do
  ...
  let(:tenant_vehicle_a) { FactoryBot.create(:legacy_tenant_vehicle, name: 'TV- A', carrier: carrier_a, organization: organization) }
  let(:tenant_vehicle_b) { FactoryBot.create(:legacy_tenant_vehicle, name: 'TV-B', carrier: carrier_b, organization: organization) }
