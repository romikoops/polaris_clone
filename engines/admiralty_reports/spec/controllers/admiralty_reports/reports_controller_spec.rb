...
module AdmiraltyReports
  RSpec.describe ReportsController, type: :controller do
    ...
    let!(:quote_organizations_scope) {
      FactoryBot.create(:organizations_scope,
        target: quote_organization,
        content: {open_quotation_tool: true})
    }
    let!(:booking_organizations_scope) {
      FactoryBot.create(:organizations_scope,
        target: booking_organization,
        content: {open_quotation_tool: false})
    }
