...
RSpec.describe ExcelDataServices::Extractors::GeoDataPreparer do
  ...
  describe ".data" do
    ...
    context "when the identifier is locode" do
      ...
      let(:raw_data) { { primary: "ZACPT", secondary: "Western Cape", country_code: "ZA" }.stringify_keys }
    ...
    context "when the identifier is postal_city" do
      ...
      let(:raw_data) { { primary: "7795 - Cape Town", secondary: "Western Cape", country_code: "ZA" }.stringify_keys }
