  ...
  describe "#perform" do
    let(:frame_data) do
      [
        ...
        { "value" => 250.0, "header" => "cbm_ratio", "row" => 2, "column" => "C", "sheet_name" => "Sheet3" },
        { "value" => "EUR", "header" => "currency", "row" => 2, "column" => "B", "sheet_name" => "Sheet3" },
        { "value" => 1.0, "header" => "base", "row" => 2, "column" => "F", "sheet_name" => "Sheet3" },
        { "value" => 8.0, "header" => "load_meterage_stackable_limit", "row" => 2, "column" => "P", "sheet_name" => "Sheet3" },
        { "value" => 5.0, "header" => "load_meterage_non_stackable_limit", "row" => 2, "column" => "Q", "sheet_name" => "Sheet3" },
        ...
        { "value" => 283.92, "header" => "rate", "row" => 6, "column" => "C", "sheet_name" => "Sheet3" },
        ...
        { "value" => "0.0 - 100.0", "header" => "bracket", "row" => 4, "column" => "C", "sheet_name" => "Sheet3" },
        { "value" => "kg", "header" => "modifier", "row" => 3, "column" => "C", "sheet_name" => "Sheet3" },
        ...
        { "value" => 30.0, "header" => "shipment", "row" => 2, "column" => "L", "sheet_name" => "Fees" },
