...
RSpec.describe ExcelDataServices::V4::Operations::CounterpartHubExpander do
  ...
  describe "#data" do
    ...
    context "when the counterpart assigned fees overlaps with general fees" do
      ...
      it "returns overwrites the general fee to the rows with counterpart_locode == 'ZACPT'" do
