...
RSpec.describe ExcelDataServices::V4::Files::Parsers::Validators do
  ...
  describe "#row_validations" do
    ...
    it "returns all Row Validations defined in the schema", :aggregate_failures do
      expect(service.row_validations.map(&:class)).to match_array([ExcelDataServices::V4::Files::RowValidation] * 2)
