...
RSpec.describe ExcelDataServices::V2::Operations::ExpandedDates do
  ...
  describe "#data" do
    ...
    context "with no conflicts (sequential)" do
      ...
      it "returns the frame with the baf fee split for the three periods" do
        expect(extracted_table[extracted_table["fee_code"] == "baf"][["effective_date", "expiration_date"]].to_a.uniq).to match_array(
          [
