...
RSpec.describe ExcelDataServices::Validators::TypeValidity::Types::ZoneRangeType do
  describe ".valid?" do
    ...
    it "returns true if is NaN" do
      expect(described_class.new(Float::NAN)).to be_valid
    end

    it "returns true if is nil" do
