...
RSpec.describe ExcelDataServices::Validators::TypeValidity::Types::CountryCodeType do
  describe ".valid?" do
    ...
    it "returns true if string is valid" do
      expect(described_class.new("DE")).to be_valid
    end
  end
end
