...
RSpec.describe ExcelDataServices::V3::Files::SheetValidator do
  ...
  describe "#valid?" do
    ...
    context "when the required Column cannot be found on the sheet" do
      let(:columns) { [instance_double("ExcelDataServices::V3::Files::Tables::Column", required: true, present_on_sheet?: false)] }
    ...
    context "when the Column cannot be found on the sheet, but is not required" do
      let(:columns) { [instance_double("ExcelDataServices::V3::Files::Tables::Column", required: false, present_on_sheet?: false)] }
    ...
    context "when the Requirements are not met" do
      let(:requirements) { [instance_double("ExcelDataServices::V3::Files::Requirements", valid?: false)] }
