...
RSpec.describe ExcelDataServices::V3::Files::DataFramer do
  ...
  let(:section_parser) { instance_double(ExcelDataServices::V3::Files::SectionParser, framer: ExcelDataServices::V3::Framers::Table) }
  let(:framer_double) { instance_double(ExcelDataServices::V3::Framers::Table, perform: framed_data, errors: errors) }
  ...
  describe "#perform" do
    before { allow(ExcelDataServices::V3::Framers::Table).to receive(:new).and_return(framer_double) }
