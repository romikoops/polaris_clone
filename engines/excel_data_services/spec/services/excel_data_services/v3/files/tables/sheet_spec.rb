...
RSpec.describe ExcelDataServices::V3::Files::Tables::Sheet do
  include_context "V3 setup"

  let(:column) do
    instance_double(ExcelDataServices::V3::Files::Tables::Column,
  ...
  let(:matrix) do
    instance_double(ExcelDataServices::V3::Files::Tables::Matrix,
      present_on_sheet?: true,
      valid?: true,
      header: "header_b",
      sheet_name: "Sheet1",
  ...
  let(:dynamic_column) { instance_double(ExcelDataServices::V3::Files::Tables::DynamicColumns) }
  ...
  let(:section_parser) { instance_double(ExcelDataServices::V3::Files::SectionParser, columns: [column], matrixes: [matrix], dynamic_columns: [dynamic_column]) }
