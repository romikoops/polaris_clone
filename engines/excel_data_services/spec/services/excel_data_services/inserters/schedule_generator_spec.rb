...
RSpec.describe ExcelDataServices::Inserters::ScheduleGenerator do
  describe ".perform" do
    ...
    let!(:misspelled_itinerary) do
      FactoryBot.create(:legacy_itinerary, organization: organization, name: "Sahnghai - Felixstowe",
    ...
    context "with base pricing" do
      before do
        ([itinerary] | multi_mot_itineraries).each do |it|
          FactoryBot.create(:lcl_pricing, itinerary: it, tenant_vehicle: tenant_vehicle1)
          FactoryBot.create(:fcl_20_pricing, itinerary: it, tenant_vehicle: tenant_vehicle2)
          FactoryBot.create(:fcl_40_pricing, itinerary: it, tenant_vehicle: tenant_vehicle2)
          FactoryBot.create(:fcl_40_hq_pricing, itinerary: it, tenant_vehicle: tenant_vehicle2)
        end
      end
