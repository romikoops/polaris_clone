  ...
  module Restructurers
    class Base < ExcelDataServices::Base
      ...
      def expand_fcl_to_all_sizes(rows_data)
        ...
        expanded_local_charges_params = Legacy::Container::CARGO_CLASSES.reduce([]) { |memo, fcl_size|
          memo + plain_fcl_local_charges_params.map { |params|
