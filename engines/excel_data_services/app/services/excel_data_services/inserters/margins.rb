  ...
  module Inserters
    class Margins < ExcelDataServices::Inserters::Base
      ...
      def create_margin_with_margin_details(group_of_row_data, row, tenant_vehicle, itinerary)
        margin_params = margin_params_from_data(
          group_of_row_data: group_of_row_data,
          row: row,
        ...
        return if margin_applies_to_all_fees?(group_of_row_data.size, row.fee_code)
      ...
      def margin_params_from_data(group_of_row_data:, row:, tenant_vehicle:, itinerary:)
