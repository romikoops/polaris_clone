...
module ExcelDataServices
  module V4
    module Operations
      class ExpandedDates < ExcelDataServices::V4::Operations::Base
        ...
        class ExpandedFrame
          ...
          def expanded_dates_for_row
            @expanded_dates_for_row ||= validities.inject(Rover::DataFrame.new) do |result, validity|
              result.concat(ExcelDataServices::V4::Operations::Dynamic::ExpandedDatesFrame.new(row: validity, row_frame: frame).frame)
            end
          end
        end
      end
