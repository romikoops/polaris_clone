...
module ExcelDataServices
  module V2
    class Upload
      ...
      def sheet
        @sheet ||= schema_types.map { |schem_type| ExcelDataServices::V2::Files::SheetType.new(file: file, type: schem_type, arguments: arguments) }.find(&:valid?)
      end

      def schema_types
        %w[SacoPricings Pricings Schedules]
      end
