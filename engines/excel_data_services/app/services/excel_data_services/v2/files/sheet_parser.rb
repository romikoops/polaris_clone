      ...
      class SheetParser
        ...
        def initialize_section
          sorted_dependencies.each do |dependency_section|
            schema_file = File.read(File.expand_path("./section_data/#{dependency_section.underscore}.rb", __dir__))
        ...
        def initialize_sheet_type
          schema_file = File.read(File.expand_path("./file_data/#{section.underscore}.rb", __dir__))
        ...
        class ConnectedActions
          ...
          def populate_columns
            schema_file = File.read(File.expand_path("./section_data/#{section.underscore}.rb", __dir__))
