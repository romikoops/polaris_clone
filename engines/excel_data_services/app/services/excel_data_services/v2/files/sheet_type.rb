  ...
  module V2
    module Files
      class SheetType
        ...
        def state
          @state ||= ExcelDataServices::V2::State.new(
            file: file,
            section: type,
        ...
        def pipelines
          @pipelines ||= sheet_parser.pipelines.map { |pipeline| ExcelDataServices::V2::Files::Section.new(state: duplicate_state_for_section(section: pipeline)) }
        end
