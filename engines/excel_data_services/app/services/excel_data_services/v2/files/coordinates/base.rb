        ...
        class Base
          ...
          class CoordinateSwitch
            ...
            def perform
              case coordinates
              when /\?/
                ExcelDataServices::V2::Files::Coordinates::Dynamic
              when /last_/, /first_/
                ExcelDataServices::V2::Files::Coordinates::Relative
              when /\||,/
                ExcelDataServices::V2::Files::Coordinates::List
              else
                ExcelDataServices::V2::Files::Coordinates::Range
              end
            end
