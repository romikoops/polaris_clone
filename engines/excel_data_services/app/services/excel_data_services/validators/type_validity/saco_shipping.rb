    ...
    module TypeValidity
      class SacoShipping < ExcelDataServices::Validators::TypeValidity::Base
        COLUMN_TO_CLASS_LOOKUP = {
          ...
          'destination_country': ExcelDataServices::Validators::TypeValidity::Types::OptionalStringType,
          'destination_hub': ExcelDataServices::Validators::TypeValidity::Types::OptionalStringType,
