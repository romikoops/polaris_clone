...
module Api
  module V2
    class QuerySerializer < Api::ApplicationSerializer
      attributes %i[id aggregated billable load_type origin_name destination_name reference modes_of_transport client load_type offer_id issue_date origin_id destination_id]
