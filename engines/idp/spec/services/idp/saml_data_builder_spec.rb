...
RSpec.describe IDP::SamlDataBuilder, type: :request do
  ...
  describe ".perform" do
    context "when the user doesn't exist" do
      ...
      it "creates a Profile object for the user", :aggregated_failures do
    ...
    context "with successful login and group param present" do
      let!(:user) { FactoryBot.create(:users_client, email: email, organization: organization) }
      ...
      it "attaches the user to a group", :aggregated_failures do
