  ...
  class Vehicle < ApplicationRecord
    ...
    def self.create_from_name(name:, mot:, organization_id:, carrier_name: nil)
      ...
      if carrier_name
        ...
        tv = carrier.tenant_vehicles.find_or_create_by(
          name: name, mode_of_transport: mot, vehicle_id: vehicle.id, organization_id: organization_id
        )
      else
        tv = TenantVehicle.find_or_create_by(
          name: name, mode_of_transport: mot, vehicle_id: vehicle.id, organization_id: organization_id
        )
      end
