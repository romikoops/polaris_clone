class CreateRatesDiscounts < ActiveRecord::Migration[5.2]
  def change
    create_table :rates_discounts, id: :uuid do |t|
      ...
      t.references :applicable_to, polymorphic: true, type: :uuid,
                                   index: {name: "index_rates_discounts_on_applicable_to_type_and_id"}
      t.integer :operator
