...
RSpec.describe Trucking::Queries::Base do
  ...
  before do
    stub_request(:get, "https://maps.googleapis.com/maps/api/directions/xml?alternative=false&departure_time=now&destination=57.694253,11.854048&key=&language=en&mode=driving&origin=57.694253,11.854048&traffic_model=pessimistic")
      .with(
        headers: {
          "Accept" => "*/*",
