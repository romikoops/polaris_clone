...
RSpec.shared_context "journey_pdf_setup" do
  ...
  before do
    ...
    FactoryBot.create(:legacy_hub, name: origin_transfer_text, hub_type: "ocean", hub_code: origin_locode, organization: organization)
    FactoryBot.create(:legacy_hub, name: destination_transfer_text, hub_type: "ocean", hub_code: destination_locode, organization: organization)
