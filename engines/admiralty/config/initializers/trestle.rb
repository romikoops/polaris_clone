require "trestle/auth/backends/google"
...
Trestle.configure do |config|
  ...
  #
  config.auth.backend = Trestle::Auth::Backends::Google

  #
  # Specify the user class to be used by trestle-auth.
  #
  config.auth.user_class = -> { ::Users::Admin }
  ...
  #
  config.auth.redirect_on_logout = -> { "/admiralty" }
