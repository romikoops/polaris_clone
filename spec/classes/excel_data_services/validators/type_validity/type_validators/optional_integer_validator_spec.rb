...
RSpec.describe ExcelDataServices::Validators::TypeValidity::TypeValidators::OptionalIntegerValidator do
  describe ".valid?" do
    ...
    it "returns false if input is not a valid integer" do
