...
RSpec.describe BackfillTestShipmentsAndQuotationsBillingWorker, type: :worker do
  context "when organization scope has no blacklisted emails" do
    ...
    let(:test_user) { FactoryBot.create(:users_client, email: "somebody@itsmycargo.com") }

    it "adds email to blacklist", skip: "Already ran and models have been migrated" do
