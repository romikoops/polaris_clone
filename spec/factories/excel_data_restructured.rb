    ...
    trait :correct_saco_shipping_pricings do
      data do
        [[{ sheet_name: 'Africa',
            ...
            fee_min: 0.2715e4,
            load_type: 'fcl_20',
            notes: [{ header: 'Electronic Cargo Tracking Note/Waiver (Ectn/Besc)', body: nil }, { header: 'Import Lizenz Nr (Form)', body: nil }, { body: 'ABC TERMINAL', header: 'Terminal' }, { header: 'Transshipment Via', body: 'CGPNR' }, { header: 'Remarks', body: 'some remark' }],
            origin: 'Hamburg',
            country_origin: nil,
            destination: 'Cabinda',
    ...
    trait :correct_saco_shipping_local_charges do
      data do
        [{ carrier: 'CMA CGM',
           ...
           fees: { 'INCLUDED_LSF' => { currency: nil, key: 'INCLUDED_LSF', min: 0, max: nil, name: 'Lsf (included)', rate_basis: 'PER_CONTAINER', value: 0 },
         ...
         { carrier: 'CMA CGM',
           ...
           hub_name: 'Hamburg Port',
           counterpart_hub_name: 'Cabinda Port',
           fees: { 'INCLUDED_BAF' => { currency: nil, key: 'INCLUDED_BAF', min: 0, max: nil, name: 'Baf (included)', rate_basis: 'PER_CONTAINER', value: 0 } },
           row_nr: '2' },
         { carrier: 'CMA CGM',
           effective_date: Date.parse('Tue, 01 Jan 2019'),
           expiration_date: Date.parse('Thu, 31 Jan 2019'),
         ...
         { carrier: 'CMA CGM',
           ...
           counterpart_hub_name: 'Cabinda Port',
           fees: { 'INCLUDED_BAF' => { currency: nil, key: 'INCLUDED_BAF', min: 0, max: nil, name: 'Baf (included)', rate_basis: 'PER_CONTAINER', value: 0 },
                   'INCLUDED_CAF' => { currency: nil, key: 'INCLUDED_CAF', min: 0, max: nil, name: 'Caf (included)', rate_basis: 'PER_CONTAINER', value: 0 } },
           row_nr: '2, 2' },
         { carrier: 'CMA CGM',
           effective_date: Date.parse('Sat, 01 Jun 2019'),
           expiration_date: Date.parse('Sun, 30 Jun 2019'),
         ...
         { carrier: 'CMA CGM',
           ...
           hub_name: 'Hamburg Port',
           counterpart_hub_name: 'Cabinda Port',
           fees: { 'INCLUDED_CAF' => { currency: nil, key: 'INCLUDED_CAF', min: 0, max: nil, name: 'Caf (included)', rate_basis: 'PER_CONTAINER', value: 0 } },
           row_nr: '2' },
         { carrier: 'CMA CGM',
           effective_date: Date.parse('Wed, 01 May 2019'),
           expiration_date: Date.parse('Fri, 31 May 2019'),
         ...
         { carrier: 'CMA CGM',
           ...
           hub: 'Cabinda',
           country: 'Angola',
           counterpart_hub: 'Hamburg',
           counterpart_country: nil,
           direction: 'import',
           service_level: 'standard',
           hub_name: 'Cabinda Port',
           counterpart_hub_name: 'Hamburg Port',
