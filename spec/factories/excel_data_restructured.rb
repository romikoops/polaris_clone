      ...
      data do
        [[{ sheet_name: 'Sheet1',
         ...
         [{ sheet_name: 'Sheet1',
            ...
            expiration_date: Date.parse('Thu, 15 Mar 2018'),
            customer_email: nil,
            origin: 'Gothenburg',
            country_origin: 'Sweden',
            destination: 'Shanghai',
      ...
      data do
        [
          { hub: 'Bremerhaven',
            ...
            counterpart_hub: nil,
            direction: 'export',
            fees: { 'CMP': { 'max': nil, 'min': nil, 'name': 'Compliance Fee', 'value': 2.7, 'currency': 'EUR', 'rate_basis': 'PER_SHIPMENT' },
                    'DOC': { 'key': 'DOC', 'max': nil, 'min': nil, 'name': 'Documentation', 'value': 20, 'currency': 'EUR', 'rate_basis': 'PER_WRONG' },
                    'ISP': { 'key':  'ISP', 'max':  nil, 'min':  nil, 'name': 'ISPS', 'value': nil, 'rate_basis': 'PER_SHIPMENT' },
                    'QDF': { 'key':  'QDF', 'max':  125, 'min':  55, 'ton': 40, 'name': 'Quay dues', 'currency': 'EUR', 'rate_basis': 'PER_TON' },
                    'SOL': { 'key':  nil, 'max': nil, 'min': nil, 'name': 'SOLAS Fee', 'value': 7.5, 'currency': nil, 'rate_basis': 'PER_SHIPMENT' },
    ...
    trait :correct_saco_shipping_pricings do
      data do
        [[{ sheet_name: 'Africa',
            ...
            fee_min: 0.2715e4,
            load_type: 'fcl_20',
            notes: [{ header: 'Electronic Cargo Tracking Note/Waiver (Ectn/Besc)', body: nil, remarks: false, transshipment: false },
                    { header: 'Import Lizenz Nr (Form)', body: nil, remarks: false, transshipment: false },
                    { header: 'Remarks', body: 'some remark', remarks: true, transshipment: false },
                    { header: 'Transshipment Via', body: 'CGPNR', remarks: false, transshipment: true }],
            origin: nil,
            country_origin: nil,
            destination: 'Cabinda',
    ...
    trait :correct_saco_shipping_local_charges do
      data do
        [{ internal: true,
           ...
           carrier: 'CMA CGM',
           effective_date: Date.parse('Mon, 01 Apr 2019'),
           expiration_date: Date.parse('Wed, 01 May 2019'),
           country: nil,
           hub: nil,
           hub_locode: 'DE HAM',
         ...
         { internal: true,
           ...
           service_level: 'standard',
           fees: { 'INCLUDED_LSF' => { currency: 'EUR', key: 'INCLUDED_LSF', min: 0, max: nil, name: 'Lsf (included)', rate_basis: 'PER_CONTAINER', value: 0 },
                   'INCLUDED_BAF' => { currency: 'EUR', key: 'INCLUDED_BAF', min: 0, max: nil, name: 'Baf (included)', rate_basis: 'PER_CONTAINER', value: 0 },
                   'THC' => { currency: 'EUR', key: 'THC', min: 0.232e3, max: nil, name: 'Thc', rate_basis: 'PER_CONTAINER', value: 0.232e3 },
                   'INCLUDED_CAF' => { currency: 'EUR', key: 'INCLUDED_CAF', min: 0, max: nil, name: 'Caf (included)', rate_basis: 'PER_CONTAINER', value: 0 },
                   'EBS' => { currency: 'EUR', key: 'EBS', min: 0.45e2, max: nil, name: 'Ebs', rate_basis: 'PER_CONTAINER', value: 0.45e2 },
                   'ISPS' => { currency: 'EUR', key: 'ISPS', min: 0.27e2, max: nil, name: 'Isps', rate_basis: 'PER_CONTAINER', value: 0.27e2 } },
         ...
         { internal: true,
           ...
           load_type: 'fcl_20',
           carrier: 'CMA CGM',
           effective_date: Date.parse('Sun, 30 Jun 2019'),
           expiration_date: Date.parse('Sat, 31 Aug 2019'),
           country: nil,
           hub: nil,
           hub_locode: 'DE HAM',
