    ...
    trait :correct_saco_shipping_pricings do
      data do
        [[{ sheet_name: 'Africa',
            ...
            fee_min: 0.2715e4,
            load_type: 'fcl_20',
            notes: [{ header: 'Electronic Cargo Tracking Note/Waiver (Ectn/Besc)', body: nil }, { header: 'Import Lizenz Nr (Form)', body: nil }, { header: 'Transshipment Via', body: 'CGPNR' }, { header: 'Remarks', body: 'some remark' }],
            origin: 'Hamburg',
            country_origin: nil,
            destination: 'Cabinda',
