    ...
    trait :correct_saco_shipping_pricings do
      data do
        [[{ sheet_name: 'Africa',
            ...
            fee_min: 0.2715e4,
            load_type: 'fcl_20',
            notes: [{ header: 'Electronic Cargo Tracking Note/Waiver (Ectn/Besc)', body: nil, transshipment: false, remarks: false },
                    { header: 'Import Lizenz Nr (Form)', body: nil, transshipment: false, remarks: false },
                    { header: 'Transshipment Via', body: 'CGPNR', transshipment: true, remarks: false },
                    { header: 'Remarks', body: 'some remark', transshipment: false, remarks: true }],
            origin: nil,
            country_origin: nil,
            destination: 'Cabinda',
