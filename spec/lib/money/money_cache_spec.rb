...
require_relative '../../../lib/money/cache.rb'

RSpec.describe MoneyCache do
  let(:money_cache) { described_class.new }

  before do
    stub_request(:get, /openexchangerates/)
      .to_return(status: 200, body: file_fixture('oxr_rates.json'), headers: {})
  end
