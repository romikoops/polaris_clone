...
ActiveRecord::Schema.define(version: 2019_04_09_105458) do
  ...
  create_table "margins_details", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "margin_id"
    t.decimal "value"
    t.string "operator"
    t.integer "charge_category_id"
  ...
  create_table "margins_margins", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.integer "tenant_id"
    t.uuid "pricing_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["applicable_type", "applicable_id"], name: "index_margins_margins_on_applicable_type_and_applicable_id"
    t.index ["cargo_class"], name: "index_margins_margins_on_cargo_class"
    t.index ["effective_date"], name: "index_margins_margins_on_effective_date"
    t.index ["expiration_date"], name: "index_margins_margins_on_expiration_date"
    t.index ["itinerary_id"], name: "index_margins_margins_on_itinerary_id"
    t.index ["pricing_id"], name: "index_margins_margins_on_pricing_id"
    t.index ["tenant_id"], name: "index_margins_margins_on_tenant_id"
    t.index ["tenant_vehicle_id"], name: "index_margins_margins_on_tenant_vehicle_id"
  end
