...
ActiveRecord::Schema.define(version: 20_181_219_093_407) do
  ...
  create_table 'geometries', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(name_1 name_2 name_3 name_4), name: 'index_geometries_on_name_1_and_name_2_and_name_3_and_name_4', unique: true
  end
  ...
  create_table 'hub_truckings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(trucking_pricing_id trucking_destination_id hub_id), name: 'foreign_keys', unique: true
  end
  ...
  create_table 'locations', force: :cascade do |t|
    ...
    t.index %w(postal_code suburb neighbourhood city province country), name: 'uniq_index', unique: true
  end
  ...
  create_table 'pricing_details', force: :cascade do |t|
    ...
    t.index %w(priceable_type priceable_id), name: 'index_pricing_details_on_priceable_type_and_priceable_id'
