...
ActiveRecord::Schema.define(version: 2020_09_24_084551) do
  ...
  create_table "companies_memberships", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_companies_memberships_on_deleted_at"
  ...
  create_table "rates_margins", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.bigint "amount_cents", default: 0, null: false
    t.string "amount_currency", null: false
    t.uuid "applicable_to_id"
    t.string "applicable_to_type"
    ...
    t.daterange "validity"
    t.numrange "wm_range"
    t.index ["applicable_to_type", "applicable_to_id"], name: "index_rates_margins_on_applicable_to_type_and_applicable_to_id"
    t.index ["cargo_class"], name: "index_rates_margins_on_cargo_class"
    t.index ["cargo_type"], name: "index_rates_margins_on_cargo_type"
    t.index ["organization_id"], name: "index_rates_margins_on_organization_id"
    t.index ["target_type", "target_id"], name: "index_rates_margins_on_target_type_and_target_id"
  end
  ...
  create_table "users_settings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.uuid "user_id"
    t.index ["deleted_at"], name: "index_users_settings_on_deleted_at"
