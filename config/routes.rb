...
# v2_organization_admin_company_groups_memberships GET    /v2/organizations/:organization_id/admin/companies/:company_id/groups_memberships(.:format)     api/v2/admin/groups_memberships#index
#                                                  POST   /v2/organizations/:organization_id/admin/companies/:company_id/groups_memberships(.:format)     api/v2/admin/groups_memberships#create
#  v2_organization_admin_company_groups_membership DELETE /v2/organizations/:organization_id/admin/companies/:company_id/groups_memberships/:id(.:format) api/v2/admin/groups_memberships#destroy
...
#                     v2_organization_admin_groups GET    /v2/organizations/:organization_id/admin/groups(.:format)                                       api/v2/admin/groups#index
#                                                  POST   /v2/organizations/:organization_id/admin/groups(.:format)                                       api/v2/admin/groups#create
#                      v2_organization_admin_group PATCH  /v2/organizations/:organization_id/admin/groups/:id(.:format)                                   api/v2/admin/groups#update
#                                                  PUT    /v2/organizations/:organization_id/admin/groups/:id(.:format)                                   api/v2/admin/groups#update
#                                                  DELETE /v2/organizations/:organization_id/admin/groups/:id(.:format)                                   api/v2/admin/groups#destroy
