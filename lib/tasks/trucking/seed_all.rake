  ...
  task :seed_all, [] => :environment do
    targets = {
      normanglobal: [
        ...
        { 
          hub: "Felixstowe Port",
          urls: ['data/normanglobal/normanglobal__trucking_ftl__felixstowe_port.xlsx', 'data/normanglobal/normanglobal__trucking_ltl__felixstowe_port.xlsx']
        },
        { 
          hub: "Ningbo Port",
      ...
      greencarrier: [
        { 
          hub: "Gothenburg Port",
          urls: ['data/greencarrier/greencarrier__trucking_ftl__gothenburg_port.xlsx', 'data/greencarrier/greencarrier__trucking_ltl__gothenburg_port.xlsx']
        },
        { 
          hub: "Shanghai Port",
          urls: ['data/greencarrier/greencarrier__trucking_ftl__shanghai_port.xlsx', 'data/greencarrier/greencarrier__trucking_ltl__shanghai_port.xlsx']
        },
        { 
          hub: "Ipswich Port",
    ...
    targets.each do |subdomain, values|
      ...
      values.each do |hub_and_urls|
        ...
        hub_and_urls[:urls].each do |url|
          ...
          ).presigned_url(:get_object, bucket: 'assets.itsmycargo.com', key: url, response_content_disposition: 'attachment')
